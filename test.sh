...
python test.py --ckpt "save_dir/best_model_Adam_0.001.pth" --data_root "dataset/data/mini-imagenet/sampled/val-10-50-in" --visualize --method tsne
python test.py --ckpt "save_dir/best_model_Adam_0.001.pth" --data_root "dataset/data/mini-imagenet/sampled/val-10-50-in" --visualize --method pca